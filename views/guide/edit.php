...
<div class="sidebar">
    ...
    <a href="?act=guide-list">Quản lý Guide</a>
        ...
        <form method="POST" action="?act=guide-update">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" required value="<?php echo htmlspecialchars($guide['name']); ?>">
                </div>

                <div class="form-group">
                    <label for="email">Email *</label>
                    <input type="email" id="email" name="email" required value="<?php echo htmlspecialchars($guide['email']); ?>">
                </div>

                <div class="form-group">
                    <label for="sdt">Số Điện Thoại *</label>
                    <input type="text" id="sdt" name="sdt" required value="<?php echo htmlspecialchars($guide['sdt']); ?>">
                </div>

                <div class="form-group">
                    <label for="exp">Kinh Nghiệm *</label>
                    <input type="text" id="exp" name="exp" required value="<?php echo htmlspecialchars($guide['exp']); ?>">
                </div>
                
            <div class="form-group">
                <label for="language">Ngôn Ngữ *</label>
                <textarea id="language" name="language" required><?php echo htmlspecialchars($guide['language']); ?></textarea>
            </div>

            <div class="form-actions">
                <button type="submit" class="btn btn-primary">Cập Nhật Khách Hàng</button>
                <a href="?act=guide-list" class="btn btn-secondary" style="text-decoration: none; display: inline-block;">Hủy</a>
            </div>
        </form>
    </div>
</div>
