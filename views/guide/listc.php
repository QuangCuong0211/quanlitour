...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="?act=tour-list">Quản lý hdv</a>
    ...
    <div class="content">
        <div class="card">
            ...
            <?php if (empty($guides)): ?>
                <div class="empty">
                    <p>Chưa có khách hàng nào. <a href="?act=guide-add">Thêm hdv mới</a></p>
                </div>
            <?php else: ?>
                <table>
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($guides as $gui): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="status <?php echo $gui['status'] == 1 ? 'active' : 'inactive'; ?>">
                                        <?php echo $gui['status'] == 1 ? 'Hoạt động' : 'Khóa'; ?>
                                    </span>
                                </td>
                                <td>
                                    <div class="actions">
