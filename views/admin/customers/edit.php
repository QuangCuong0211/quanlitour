        ...
        <form method="POST" action="?act=customer-update">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="identity_number" name="identity_number" value="<?= htmlspecialchars($customer['identity_number'] ?? '') ?>">
                </div>
            </div>
            ...
            <div class="button-group">
                ...
                <button type="submit" class="btn btn-submit">Cập Nhật Khách Hàng</button>
            </div>
        </form>
    </div>
</body>
